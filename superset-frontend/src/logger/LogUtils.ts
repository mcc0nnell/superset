...
export const LOG_ACTIONS_DASHBOARD_DOWNLOAD_EVIDENCE_MANIFEST =
  'dashboard_download_evidence_manifest';
export const LOG_ACTIONS_DASHBOARD_EXPORT_XLSX = 'dashboard_export_xlsx';
